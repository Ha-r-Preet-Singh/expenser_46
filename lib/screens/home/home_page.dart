...
import 'package:sir_expenso/models/filter_expense_model.dart';
import 'package:sir_expenso/screens/add_transaction/add_trans_page.dart';
      ...
      body: BlocBuilder<ExpenseBloc, ExpenseState>(
        builder: (_, state) {
          if (state is ExpenseLoadingState) {
            ...
            return arrFilterDateExpenses.isNotEmpty
                ? ListView.builder(
                        ...
                        children: [
                          ...
                          ListView.builder(
                              ...
                              itemBuilder: (_, subIndex) {
                                var eachTrans = arrFilterDateExpenses[index]
                                    .arrExpense[subIndex];
                                return ListTile(
